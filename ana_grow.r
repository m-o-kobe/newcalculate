...
data1.glm<-lm(formula = growth ~ dbh01 + crd1 + crd2 + crd3 + crd4 + crd5 + crd6 + crd7 + crd8 + crd9 + kabudachi, data = data)
data2.step<-step(data1.glm)
data3.glm<-lm(formula = growth ~ dbh01 + crd+ kabudachi, data = data)
