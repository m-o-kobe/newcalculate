...
CSV.open('n_rand_'+plot+'_'+$targetspp+'1127.csv','w') do |test|
	test << ["plot",plot]
	test << ["spp",$targetspp]
	test << ["hanpuku",hanpuku]
	for i in 0..kazu do
		test << [Num[i], Xx[i],Yy[i],Crd1[i],Crd2[i],Crd3[i],Crd4[i],Crd5[i],Crd6[i],Crd7[i],Crd8[i],Crd9[i],Onaji1[i],Onaji2[i],Onaji3[i],Onaji4[i],Onaji5[i],Onaji6[i],Onaji7[i],Onaji8[i],Onaji9[i]]
